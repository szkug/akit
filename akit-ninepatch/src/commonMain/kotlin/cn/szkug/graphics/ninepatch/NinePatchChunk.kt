...
class NinePatchChunk(
    ...
    var xDivs: MutableList<Div> = mutableListOf(),
    var yDivs: MutableList<Div> = mutableListOf(),
    ...
    companion object {
        ...
        private fun readDivs(divs: Int, reader: ByteArrayReader, target: MutableList<Div>) {
            repeat(divs) {
                target.add(Div(reader.readInt(), reader.readInt()))
            }
        }
        ...
        private fun getRegions(divs: List<Div>, max: Int): MutableList<Div> {
        ...
        private fun getYDivs(image: NinePatchImage, column: Int): MutableList<Div> {
        ...
        private fun getXDivs(image: NinePatchImage, row: Int): MutableList<Div> {
        ...
        private fun processChunk(pixel: Int, tmpDiv: Div?, position: Int, divs: MutableList<Div>): Div? {
            var currentDiv = tmpDiv
            if (isBlack(pixel)) {
                if (currentDiv == null) {
                    currentDiv = Div(start = position)
                }
            }
            if (isTransparent(pixel)) {
                if (currentDiv != null) {
