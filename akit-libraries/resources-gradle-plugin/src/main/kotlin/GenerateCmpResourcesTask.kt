...
abstract class GenerateCmpResourcesTask : DefaultTask() {
    ...
    private fun writeCommonRes(
        ...
        file.writeText(buildString {
            ...
            appendLine()
            appendLine("import akit.resources.runtime.ResourceId")
            appendLine("import akit.resources.runtime.StringResourceId")
            appendLine("import akit.resources.runtime.PluralStringResourceId")
            appendLine("import akit.resources.runtime.ColorResourceId")
            appendLine("import akit.resources.runtime.DimenResourceId")
            appendLine("import akit.resources.runtime.PaintableResourceId")
            appendLine("import akit.resources.runtime.RawResourceId")
            appendLine()
