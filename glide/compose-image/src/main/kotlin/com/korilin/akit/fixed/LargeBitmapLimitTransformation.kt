package com.korilin.akit.fixed
...
import com.korilin.akit.compose.image.publics.BitmapTransformation
...
internal object LargeBitmapLimitTransformation : BitmapTransformation() {
    ...
    override fun transform(context: Context, resource: Bitmap, width: Int, height: Int): Bitmap {
        val defaultOptions = Glide.get(context).visibleGlideContext.defaultRequestOptions
