...
abstract class GenerateCmpResourcesTask : DefaultTask() {
    ...
    private fun writeCommonRes(
        ...
        file.writeText(buildString {
            ...
            appendLine()
            appendLine("import munchkin.resources.runtime.ResourceId")
            appendLine("import munchkin.resources.runtime.StringResourceId")
            appendLine("import munchkin.resources.runtime.PluralStringResourceId")
            appendLine("import munchkin.resources.runtime.ColorResourceId")
            appendLine("import munchkin.resources.runtime.DimenResourceId")
            appendLine("import munchkin.resources.runtime.PaintableResourceId")
            appendLine("import munchkin.resources.runtime.RawResourceId")
            appendLine()
