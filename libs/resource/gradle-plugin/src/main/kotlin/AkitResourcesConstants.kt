 ...
 */
object MunchkinResourcesConstants {
    const val LOG_PREFIX = "MunchkinResources"
 ...
 */
object MunchkinResourcesMessages {
    fun syncSkipMissingEnv(): String =
        "Skipping ${MunchkinResourcesGradleConstants.TASK_SYNC_XCODE}: missing " +
 ...
 */
object MunchkinResourcesLog {
    /** Print a line with a consistent prefix for easier filtering. */
    fun info(message: String) {
        println("${MunchkinResourcesConstants.LOG_PREFIX} $message")
    }
}
