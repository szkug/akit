...
abstract class GenerateCmpResourcesTask : DefaultTask() {
    ...
    private fun writeIosRes(
        ...
        file.writeText(buildString {
            ...
            appendLine("import cn.szkug.akit.graph.ninepatch.ImageBitmapNinePatchSource")
            appendLine("import cn.szkug.akit.graph.ninepatch.NinePatchPainter")
            appendLine("import cn.szkug.akit.graph.ninepatch.NinePatchChunk")
            appendLine("import cn.szkug.akit.graph.ninepatch.NinePatchType")
            appendLine("import cn.szkug.akit.graph.ninepatch.parseNinePatch")
            ...
            appendLine("    val ninePatchSource = ImageBitmapNinePatchSource(bitmap)")
            appendLine("    val parsed = parseNinePatch(ninePatchSource, null)")
            appendLine("    return if (parsed.type == NinePatchType.Raw) {")
            appendLine("        val chunk = parsed.chunk ?: NinePatchChunk.createEmptyChunk()")
