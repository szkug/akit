...
internal fun Modifier.coilPainterNode(
...
private data class CoilPainterElement(
...
) : ModifierNodeElement<CoilPainterNode>() {

    override fun create(): CoilPainterNode {
        return CoilPainterNode(
            requestModel = requestModel,
            placeholderModel = placeholderModel,
            failureModel = failureModel,
            alignment = alignment,
    ...
    override fun update(node: CoilPainterNode) {
...
private const val TRACE_SECTION_NAME = "CoilPainterNode"

internal class CoilPainterNode(
    requestModel: RequestModel,
    placeholderModel: PainterModel?,
    failureModel: ResourceModel?,
    contentScale: ContentScale,
    ...
    override fun MeasureScope.measure(
        ...
        val inferredSize = modified.inferredCoilSize()
